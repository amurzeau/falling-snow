...
function monitorFPS(canvas, runtimeState, snow_count) {
...
window.onload = function () {
    setTimeout(() => __awaiter(this, void 0, void 0, function* () {
        ...
        const shaderProgram = glutils.initShaderProgram(shaders.vsSource, shaders.fsSource);
        const shaderCopyProgram = glutils.initShaderProgram(shaders.vsSource, shaders.fsCopySource);
        ...
        let traineau_image = yield glutils.getImageData("traineau.png");
        let background_trees_image = yield glutils.getImageData("background_trees.png");
        let maison_image = yield glutils.getImageData("maison.png");
        let sapin_image = yield glutils.getImageData("sapin.png");
